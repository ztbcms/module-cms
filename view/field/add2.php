                ...
                <div>
                    <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="210px">
                        ...
                        <div v-if="setting === 'text'">
                            {include file="../app/cms/fields/text/field_add_form.inc.php"}
                        </div>
                        <div v-if="setting === 'textarea'">
                            {include file="../app/cms/fields/textarea/field_add_form.inc.php"}
                        </div>
                        <div v-if="setting === 'editor'">
                            {include file="../app/cms/fields/editor/field_add_form.inc.php"}
                        </div>
                        <div v-if="setting === 'box'">
                            {include file="../app/cms/fields/box/field_add_form.inc.php"}
                        </div>
                        <div v-if="setting === 'image'">
                            {include file="../app/cms/fields/image/field_add_form.inc.php"}
                        </div>
                        <div v-if="setting === 'images'">
                            {include file="../app/cms/fields/images/field_add_form.inc.php"}
                        </div>
                        <div v-if="setting === 'number'">
                            {include file="../app/cms/fields/number/field_add_form.inc.php"}
                        </div>
                        <div v-if="setting === 'datetime'">
                            {include file="../app/cms/fields/datetime/field_add_form.inc.php"}
                        </div>
                        <div v-if="setting === 'author'">
                            {include file="../app/cms/fields/author/field_add_form.inc.php"}
                        </div>
                        ...
                        <el-form-item label="字符长度取值范围">
                            <el-input v-model="formData.field_minlength" value="0" size="5" placeholder="最小值" clearable :style="{width: '100%'}" type="number"></el-input>
                            <br>
                            <br>
                            <el-input v-model="formData.field_maxlength" value="0" size="5"  placeholder="最大值" clearable :style="{width: '100%'}" type="number"></el-input>
        ...
        new Vue({
            ...
            methods: {
                getPatternVal : function () {
                    this.formData.pattern_select = this.formData.formtype;
                },
