...
<div class="wrap J_check_wrap">
    ...
    <form name="myform" class="J_ajaxForm" action="{:api_url('/cms/field/add')}" method="post">
        <div class="table_full">
            <table width="100%" class="table_form contentWrap">
                ...
                <tr>
                    ...
                    <td><textarea name="tips" rows="2" cols="20" id="tips" style="height:40px; width:80%"></textarea>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="setting[backstagefun]" value="" size="50" class="input"> <input
                            name="setting[backstagefun_type]" type="radio" value="1" checked="checked">入库前 <input
                            type="radio" name="setting[backstagefun_type]" value="2">入库后 <input type="radio"
                                                                                                name="setting[backstagefun_type]"
                                                                                                value="3">入库前后
                    </td>
                </tr>
                <tr>
                    <th><strong>前台信息处理函数</strong><br/>用法：直接填写函数名称，如果有附带参数可以在函数名后面加###参数1,参数2.完整例子：usfun###a1,a2</th>
                    <td><input type="text" name="setting[frontfun]" value="" size="50" class="input"> <input
                            name="setting[frontfun_type]" type="radio" value="1" checked="checked">入库前 <input
                            type="radio"
                            name="setting[frontfun_type]"
                            value="2">入库后
                        <input type="radio" name="setting[frontfun_type]" value="3">入库前后
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="isomnipotent" value="1"/> 是 <input type="radio" name="isomnipotent"
                                                                                     value="0" checked/> 否
                    </td>
                </tr>
                <tr>
                    <th><strong>在推荐位标签中调用</strong></th>
                    <td><input type="radio" name="isposition" value="1"/> 是 <input type="radio" name="isposition"
                                                                                   value="0"
                                                                                   checked/> 否
                    </td>
                </tr>
...
<script type="text/javascript">
    function field_setting(fieldtype) {
        ...
        $.getJSON("{:api_url('Field/public_field_setting')}", {fieldtype: fieldtype}, function (data) {
