<script type="text/x-template" id="field-setting-checkbox">
    <div class="field-setting-checkbox">
...
<script>
    $(function () {
        Vue.component('field-setting-checkbox', {
            template: '#field-setting-checkbox',
            model: {
                // 指定接收 v-model 值/修改事件
                prop: 'setting',
                event: 'change'
