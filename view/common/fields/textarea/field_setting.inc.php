<script type="text/x-template" id="field-setting-textarea">
    <div class="field-setting-textarea">
...
<script>
    $(function () {
        Vue.component('field-setting-textarea', {
            template: '#field-setting-textarea',
            model: {
                // 指定接收 v-model 值/修改事件
                prop: 'setting',
                event: 'change'
            ...
            mounted: function () {
                ...
                this.sql_type = this.setting.sql_type || 'TEXT'
                this.syncVModel()
            },
            methods: {
                // 向父组件更新绑定值
