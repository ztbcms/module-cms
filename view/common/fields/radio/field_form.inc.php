<script type="text/x-template" id="field-form-radio">
    <div class="field-form-radio">
        <el-form-item :label="name">
            <template v-for="item in option_list">
                <el-radio v-model="field_value" :label="item.value">{{item.name}}</el-radio>
            </template>
        </el-form-item>
    </div>
</script>
<script>
    $(function () {
        Vue.component('field-form-radio', {
